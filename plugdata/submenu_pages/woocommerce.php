...
if (isset($storageInfo['plan']['name']) && $storageInfo['plan']['name'] == 'Free') {
  $message = '
    ...
    <a class="sirv-plan-upgrade-btn sirv-no-blank-link-icon" style="color: #FFF;" href="https://my.sirv.com/#/account/billing/plan" target="_blank">Choose a plan</a>
  ';

  echo Utils::showMessage($message);
}
